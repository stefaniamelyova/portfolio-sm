  ...
  return (
    <>
      ...
      <R
        ...
        src={LG.decor2505}
      />
      <Text top={309} size={60} weight={900} delay={0.3}>
        stefania alberto
      </Text>
      <Text top={400} size={25} weight={600} delay={0.6}>
...
function TabletCanvas() {
  return (
    <>
      ...
      <Text top={241} size={30} weight={900} delay={0.3}>
        stefania alberto
      </Text>
      <Text top={293} size={13} weight={600} delay={0.6}>
        student&nbsp;•&nbsp;designer&nbsp;•&nbsp;developer
      </Text>
    </>
  );
...
function MobileCanvas() {
  return (
    <>
      <E x={-71} y={400} w={283} h={219} src={SM.baroqueWoman_mo} flip />
      <E x={210} y={370} w={190} h={249} src={SM.gothicWindow_mo} />
      ...
      <R
        ...
        src={SM.decor2505_mo}
      />
      <Text top={238} size={30} weight={900} delay={0.3}>
        stefania alberto
      </Text>
      <Text top={290} size={13} weight={600} delay={0.6}>
        student&nbsp;•&nbsp;designer&nbsp;•&nbsp;developer
      </Text>
    </>
  );
...
function ScaledCanvas({
  ...
  return (
    ...
    >
      <div
        style={{ position: "relative", height: h * scale, overflow: "hidden" }}
      >
        <div
          style={{
            position: "absolute",
...
export default function Hero() {
  ...
  if (bp === "sm")
    return (
      <ScaledCanvas w={375} h={596} pad={PAD.sm}>
        <MobileCanvas />
      </ScaledCanvas>
    );
  if (bp === "md")
    return (
      <ScaledCanvas w={810} h={596} pad={PAD.md}>
        <TabletCanvas />
      </ScaledCanvas>
    );
  return (
    <ScaledCanvas w={1290} h={740} pad={PAD.lg}>
      <DesktopCanvas />
    </ScaledCanvas>
  );
}

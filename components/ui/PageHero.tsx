...
export default function PageHero({ title }: PageHeroProps) {
  return (
    ...
    <div className="relative w-full h-[125px] sm:h-[168px] md:h-[210px] bg-bg overflow-hidden flex items-center justify-center mt-6 border-t border-b border-dark">
      ...
      {/* ── Left cluster — rendered back → front ────────────────────────── */}
      ...
      {/* Woman — always full height, overflows hero */}
      {/* eslint-disable-next-line @next/next/no-img-element */}
      ...
      {/* ── Right cluster — rendered back → front ───────────────────────── */}

      {/* Gothic window — always full height, overflows hero */}
      {/* eslint-disable-next-line @next/next/no-img-element */}
      ...
      {/* Rose branch — leftmost of right cluster, top */}
      {/* eslint-disable-next-line @next/next/no-img-element */}
      ...
      {/* Artichoke — leftmost of right cluster, bottom */}
      {/* eslint-disable-next-line @next/next/no-img-element */}
      ...
      {/* Botanical sprig — just left of window, top-anchored */}
      {/* eslint-disable-next-line @next/next/no-img-element */}
      ...
      {/* Flower (small) — under botanical sprig, bottom */}
      {/* eslint-disable-next-line @next/next/no-img-element */}

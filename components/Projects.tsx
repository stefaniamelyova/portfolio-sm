...
import { SectionHeader, StaggerReveal, StaggerItem } from './ui'
...
function ProjectCard({ title, description, href, coverSrc, decorSrc }: ProjectCardProps) {
  return (
    <Link
      href={href}
      className="flex flex-col h-full border border-dark overflow-hidden group transition-transform duration-300 hover:-translate-y-1"
    >
...
export default function Projects() {
  return (
    <section id="projects">
      ...
      <StaggerReveal className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6 px-6 md:px-section py-section">
        <StaggerItem>
          <ProjectCard
